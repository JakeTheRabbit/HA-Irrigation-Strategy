...
<p align="center">
  <img src="https://github.com/user-attachments/assets/0701102f-9a6a-437d-a2da-7dcaea0460d2" alt="Crop Steering for Home Assistant" width="900" />
</p>

![Operator dashboard with room overview, trends and zone readings](img/operator-dashboard.png)
...
## Operator dashboard development

The primary `www/f2.html` is now built from the React + shadcn/ui source in `frontend/`. Daily workflows are **Overview, Zones, Irrigation strategy, Activity, Sensors and Settings**. See [the dashboard guide](docs/OPERATOR_DASHBOARD.md) for development, connection behavior and packaging. The earlier full console and specialist tools remain accessible through **Help & tools** (`f2-classic.html`). Screenshots and descriptions of the old console below refer to that classic version.
