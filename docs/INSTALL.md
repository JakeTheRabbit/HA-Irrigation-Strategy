...
This release documents integration 2.18.0 and controller 0.15.1. Use the matching published pair. The public demo uses isolated synthetic data; its sample plans and records are not installation settings.
