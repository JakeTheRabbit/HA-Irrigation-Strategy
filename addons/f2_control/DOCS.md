...
The display name is Crop Steering Controller. The existing f2_control slug remains stable for upgrade compatibility. Use controller 0.16.0 with integration 2.19.0. Local browser/unit checks do not constitute a live HA installation test.
