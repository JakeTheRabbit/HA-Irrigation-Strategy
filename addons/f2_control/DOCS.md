...
The display name is Crop Steering Controller. The existing f2_control slug remains stable for upgrade compatibility. The new workspace features are unreleased until published; local browser/unit checks do not constitute a live HA installation test.
