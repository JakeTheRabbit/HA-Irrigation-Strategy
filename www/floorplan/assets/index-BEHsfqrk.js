...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(e,t,n){let r=new Float32Array(oo),i=new U(0,1,0);return new zi({name:`SphericalGaussianBlur`,defines:{n:oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:wo(),fragmentShader:`
	...
	`}var To=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,document.head.appendChild(Uu);var Wu=document.createElement(`div`);Wu.id=`hud`,document.body.appendChild(Wu);var Gu=new Vl({element:Wu});Gu.setSize(innerWidth,innerHeight),addEventListener(`resize`,()=>Gu.setSize(innerWidth,innerHeight));var Ku={},qu=e=>{let t=Ku[e];if(!t)return null;let n=parseFloat(t.state);return isFinite(n)?n:null},Ju=e=>{let t=Ku[e];return t?t.state:null},Yu=(e,t=0)=>e==null?`—`:e.toFixed(t);async function Xu(e,t,n){if(Hu){let e=n.entity_id;Ku[e]&&(Ku[e].state=Ku[e].state===`on`?`off`:`on`),sd();return}let r=Bu();if(r){try{await fetch(`/api/services/`+e+`/`+t,{method:`POST`,headers:{Authorization:`Bearer `+r,"Content-Type":`application/json`},body:JSON.stringify(n)})}catch{}setTimeout(od,800)}}function Zu(e,t,n){n&&!confirm(`Toggle `+t+`?
Grow-room lighting — wrong toggles in the dark period stress the crop.`)||Xu(e.split(`.`)[0]===`switch`?`switch`:`light`,`toggle`,{entity_id:e})}var Qu=[{key:`F1`,name:`Flower 1`,px:2.46,pz:4.6,py:2.1,rect:[.15,.15,4.5,8.9],sensors:[[`Temp`,`sensor.growsensor_temperature`,`°C`,1,[20,28]],[`RH`,`sensor.growsensor_humidity`,`%`,0,[45,70]],[`VPD`,`sensor.growsensor_vpd`,``,2,[.7,1.5]],[`Leaf`,`sensor.growsensor_lst`,`°C`,1,[18,27]],[`CO₂`,`sensor.f1_scd410_back_left_co2`,``,0,[350,1600]],[`PPFD`,`sensor.growsensor_eppfd`,``,0,null],[`PM2.5`,`sensor.air_q_f1_pm_2_5`,``,1,[0,12]]],lights:[[`All`,`light.f1_light_group`],[`R1`,`light.espoe_f1_r1_led`],[`R2`,`light.espoe_f1_r2_led`],[`R3`,`light.espoe_f1_r3_led`]],roomLights:[`light.f1_light_group`,`light.espoe_f1_r1_led`,`light.espoe_f1_r2_led`,`light.espoe_f1_r3_led`],valves:[[`Z1`,`switch.f1_irrigation_relays_relay_1`],[`Z2`,`switch.f1_irrigation_relays_relay_3`],[`Z3`,`switch.f1_irrigation_relays_relay_2`]],extras:[[`CO₂ valve`,`switch.f1_co2_ssr_tank_1`]],water:{"switch.f1_irrigation_relays_relay_1":1.24,"switch.f1_irrigation_relays_relay_3":2.46,"switch.f1_irrigation_relays_relay_2":3.69},acs:[[`climate.f1_ac_door_f1_ac_door`,`AC door`,1.3,8.85],[`climate.f1_ac_wall_f1_ac_wall`,`AC wall`,3.6,8.85]]},{key:`Veg`,name:`Veg`,px:7.1,pz:4.2,py:2.4,rect:[4.95,.15,4.35,8.9],sensors:[[`Temp`,`sensor.veg_scd41_top_temperature_scd41`,`°C`,1,[20,28]],[`RH`,`sensor.veg_scd41_top_humidity_scd41`,`%`,0,[45,75]],[`VPD`,`sensor.veg_vpd`,``,2,[.6,1.3]],[`CO₂`,`sensor.veg_scd41_top_co2`,``,0,[350,1600]]],lights:[[`L rack`,`light.veg_l1_lights_vegel_left_level_1`],[`R rack`,`light.veg_r1_lights_veg_right_level_1`]],roomLights:[`light.veg_l1_lights_vegel_left_level_1`,`light.veg_r1_lights_veg_right_level_1`],valves:[[`LT`,`switch.veg_solenoid_relays_lt`],[`LB`,`switch.veg_solenoid_relays_lb`],[`RT`,`switch.veg_solenoid_right_top`],[`RB`,`switch.veg_solenoid_relays_r_b`]],water:{"switch.veg_solenoid_relays_lt":6,"switch.veg_solenoid_right_top":8.2},acs:[[`climate.veg_ac_left_veg_ac_left`,`AC left`,6.2,8.85],[`climate.veg_ac_right_veg_ac_right`,`AC right`,8,8.85]]},{key:`F2`,name:`Flower 2`,px:12.05,pz:4.6,py:2.1,rect:[9.55,.15,5.1,8.9],sensors:[[`Temp`,`sensor.f2_scd41_env3_dlight_poe_temperature`,`°C`,1,[22,27]],[`RH`,`sensor.f2_sensor_humidity`,`%`,0,[55,68]],[`VPD`,`sensor.f2_air_vpd`,``,2,[.9,1.45]],[`Leaf`,`sensor.f2_leaf_vpd`,``,2,[.9,1.35]],[`CO₂`,`sensor.f2_scd41_env3_dlight_poe_co2`,``,0,[800,1600]],[`PPFD`,`sensor.f2_scd41_env3_dlight_poe_ppfd`,``,0,null],[`BL °C`,`sensor.f2_scd41_back_left_temperature`,`°C`,1,[22,27.5]]],lights:[[`R1`,`light.led_f2_r1_f2_r1_led`],[`R2`,`light.led_f2_r2_f2_r2_led`],[`R3`,`light.office_light_main_spectrum`],[`UC`,`light.under_canopy_1_veg_undercanopy_light_2`]],roomLights:[`light.led_f2_r1_f2_r1_led`,`light.led_f2_r2_f2_r2_led`,`light.office_light_main_spectrum`],valves:[[`Z1`,`switch.f2_row1`],[`Z2`,`switch.f2_row2`],[`Z3`,`switch.f2_row3`]],water:{"switch.f2_row1":10.68,"switch.f2_row2":13.42,"switch.f2_row3":12.05},acs:[[`climate.f2_ac_door_f2_ac_door`,`AC door`,10.9,8.85],[`climate.f2_ac_wall_f2_ac_wall`,`AC wall`,13.4,8.85]]},{key:`Vault`,name:`Drying / Vault`,px:4.65,pz:14.3,py:1.9,rect:[2.2,11.2,4.6,5.3],sensors:[[`Ruuvi A`,`sensor.ruuvi_a_temperature`,`°C`,1,[16,21]],[`Ruuvi E`,`sensor.ruuvi_e_temperature`,`°C`,1,[16,21]],[`RH A`,`sensor.ruuvi_a_humidity`,`%`,0,[50,62]],[`RH E`,`sensor.ruuvi_e_humidity`,`%`,0,[50,62]],[`ACI RH`,`sensor.f1_250_humidity`,`%`,0,[50,62]],[`Dry day`,`counter.drying_days`,``,0,null]],lights:[[`Vault`,`light.vault_lights`],[`EL2`,`light.el450ha_2`],[`EL3`,`light.el450ha_3`]],roomLights:[`light.vault_lights`],acs:[[`climate.dryingroom_vault_ac_drying_room_vault_ac`,`Ceiling AC`,4.65,13]]},{key:`Irrigation`,name:`Irrigation`,px:7.72,pz:13.4,py:2,rect:[6.4,11.2,2.6,4.4],sensors:[[`Pump W`,`sensor.pump_power_switch_power`,` W`,0,null]],lights:[[`Light`,`switch.irrigation_room_light`]],roomLights:[`switch.irrigation_room_light`],valves:[[`Pump master`,`switch.f1_irrigation_pump_master_switch`],[`Zigbee pump`,`switch.pump_power_switch`],[`Mainline F1`,`switch.espoe_irrigation_relay_1_2`],[`Hose F1`,`switch.f1_irrigation_relays_relay_4`],[`Mains water`,`switch.espoe_irrigation_relay_1_4`],[`Manifold`,`switch.espoe_irrigation_relay_2_4`],[`Tank return`,`switch.espoe_irrigation_relay_1_1`],[`Tank waste`,`switch.waste_valve`]]},{key:`Hallway`,name:`Hallway`,px:11.6,pz:10.1,py:1.6,rect:[.15,9.3,14.5,1.6],sensors:[[`Temp`,`sensor.air_q_hallway_co2_external_temperature`,`°C`,1,[16,26]],[`RH`,`sensor.air_q_hallway_co2_external_humidity`,`%`,0,[35,65]],[`CO₂`,`sensor.air_q_hallway_co2_external`,``,0,[350,1200]]],lights:[[`Lights`,`light.hallway_lights_switch`]],roomLights:[`light.hallway_lights_switch`],acs:[[`climate.hallway_ac_hallway`,`AC`,9.2,10.1]]},{key:`Office`,name:`Office (upstairs)`,px:19.05,pz:13.7,py:1.9,rect:[16.75,11.2,4.6,5.2],sensors:[[`Temp`,`sensor.esppoe_5_office_temperature`,`°C`,1,[17,26]],[`RH`,`sensor.esppoe_5_office_humidity`,`%`,0,[30,65]],[`CO₂`,`sensor.esppoe_5_office_co2`,``,0,[350,1100]]],lights:[[`Lights`,`light.office_lights`]],roomLights:[`light.office_lights`],acs:[[`climate.office_ac_office_ac`,`AC`,19.05,12.2]]}],$u=new Set([`F1`,`Veg`,`F2`]);function ed(e,t,n,r){let i=new Fl(e);return i.position.set(t,n,r),Z.add(i),i}var td=(e,t)=>e==null?`dim`:t?e<t[0]||e>t[1]?e<t[0]*.85||e>t[1]*1.15?`bad`:`warn`:`ok`:``;for(let e of Qu){let t=document.createElement(`div`);t.className=`hud`;let n=`<h4>`+e.name+`</h4><div class="rows">`;for(let t of e.sensors)n+=`<span class="dim">`+t[0]+`</span><b data-s="`+t[0]+`">—</b>`;n+=`</div>`,e.lights&&e.lights.length&&(n+=`<div class="lts" data-k="lights"></div>`),e.valves&&e.valves.length&&(n+=`<div class="lts" data-k="valves"></div>`),e.extras&&e.extras.length&&(n+=`<div class="lts" data-k="extras"></div>`),t.innerHTML=n;for(let n of[[`lights`,e.lights],[`valves`,e.valves],[`extras`,e.extras]]){let r=n[0],i=n[1];if(!i)continue;let a=t.querySelector(`[data-k="`+r+`"]`);for(let t of i){let n=t[0],i=t[1],o=document.createElement(`span`);o.className=`lt`+(r===`lights`?``:` vlv`),o.textContent=n,o.title=i,o.dataset.ent=i,o.addEventListener(`click`,t=>{t.stopPropagation(),Zu(i,e.name+` `+n,$u.has(e.key)&&r===`lights`)}),a.appendChild(o)}}ed(t,e.px,e.py,e.pz),e._el=t,e._acEls=[];for(let t of e.acs||[]){let n=t[0],r=t[1],i=t[2],a=t[3],o=document.createElement(`div`);o.className=`hud mini`,o.dataset.ent=n,o.title=n,o.innerHTML=`<span class="dim">`+r+`</span> <b data-cur>—</b><span class="dim">→</span><b data-set>—</b> <span data-mode class="acmode-off">off</span>`,ed(o,i,2.55,a),e._acEls.push([n,o])}let r=e.rect[0],i=e.rect[1],a=e.rect[2],o=e.rect[3],s=new q(new ki(a,o),new Vr({color:329484,transparent:!0,opacity:0,depthWrite:!1}));s.rotation.x=-Math.PI/2,s.position.set(r+a/2,.115,i+o/2),s.renderOrder=2,Z.add(s),e._dark=s;let c=new Ca(16769696,0,Math.max(a,o)*1.4,1.7);c.position.set(e.px,2.6,e.pz),Z.add(c),e._glow=c}function nd(){let e=document.createElement(`canvas`);e.width=64,e.height=8;let t=e.getContext(`2d`);t.fillStyle=`rgba(34,211,238,0.10)`,t.fillRect(0,0,64,8),t.fillStyle=`rgba(94,234,212,0.95)`;for(let e=0;e<64;e+=16)t.fillRect(e,0,7,8);let r=new bi(e);return r.wrapS=r.wrapT=n,r.repeat.set(6,1),r}var rd=[];for(let e of Qu)if(e.water)for(let t of Object.entries(e.water)){let e=t[0],n=t[1],r=nd(),i=new q(new ki(7.4,.16),new Vr({map:r,transparent:!0,depthWrite:!1}));i.rotation.x=-Math.PI/2,i.rotation.z=Math.PI/2,i.position.set(n,.87,4.5),i.visible=!1,i.renderOrder=3,Z.add(i);let a=new Ca(2282478,0,6,2);a.position.set(n,1.4,4.5),Z.add(a),rd.push({id:e,mesh:i,tex:r,light:a})}function id(){let e=new Set;for(let t of Qu)(t.sensors||[]).forEach(t=>e.add(t[1])),(t.lights||[]).forEach(t=>e.add(t[1])),(t.valves||[]).forEach(t=>e.add(t[1])),(t.extras||[]).forEach(t=>e.add(t[1])),(t.acs||[]).forEach(t=>e.add(t[0]));return rd.forEach(t=>e.add(t.id)),[...e]}function ad(){let e=(e,t,n)=>{Ku[e]={state:String(t),attributes:n||{}}};for(let t of Object.entries({"sensor.growsensor_temperature":25.1,"sensor.growsensor_humidity":58,"sensor.growsensor_vpd":1.18,"sensor.growsensor_lst":23.9,"sensor.f1_scd410_back_left_co2":1180,"sensor.growsensor_eppfd":880,"sensor.air_q_f1_pm_2_5":2.1,"sensor.veg_scd41_top_temperature_scd41":24.2,"sensor.veg_scd41_top_humidity_scd41":65,"sensor.veg_vpd":.95,"sensor.veg_scd41_top_co2":820,"sensor.f2_scd41_env3_dlight_poe_temperature":25.2,"sensor.f2_sensor_humidity":62,"sensor.f2_air_vpd":1.15,"sensor.f2_leaf_vpd":1.12,"sensor.f2_scd41_env3_dlight_poe_co2":1300,"sensor.f2_scd41_env3_dlight_poe_ppfd":1e3,"sensor.f2_scd41_back_left_temperature":25.6,"sensor.ruuvi_a_temperature":18.2,"sensor.ruuvi_e_temperature":18.6,"sensor.ruuvi_a_humidity":57,"sensor.ruuvi_e_humidity":58,"sensor.f1_250_humidity":59,"counter.drying_days":12,"sensor.pump_power_switch_power":420,"sensor.air_q_hallway_co2_external_temperature":21.4,"sensor.air_q_hallway_co2_external_humidity":48,"sensor.air_q_hallway_co2_external":640,"sensor.esppoe_5_office_temperature":21,"sensor.esppoe_5_office_humidity":52,"sensor.esppoe_5_office_co2":760}))e(t[0],t[1]);for(let t of id())Ku[t]||e(t,`off`);[`light.f1_light_group`,`light.espoe_f1_r1_led`,`light.espoe_f1_r2_led`,`light.espoe_f1_r3_led`,`light.led_f2_r1_f2_r1_led`,`light.led_f2_r2_f2_r2_led`,`light.office_light_main_spectrum`,`light.hallway_lights_switch`,`switch.irrigation_room_light`].forEach(t=>e(t,`on`)),e(`switch.f2_row1`,`on`),e(`switch.pump_power_switch`,`on`),e(`switch.f1_irrigation_pump_master_switch`,`on`),e(`climate.f1_ac_door_f1_ac_door`,`cool`,{temperature:26,current_temperature:25.4,hvac_action:`cooling`}),e(`climate.f1_ac_wall_f1_ac_wall`,`cool`,{temperature:26,current_temperature:25,hvac_action:`cooling`}),e(`climate.veg_ac_left_veg_ac_left`,`heat`,{temperature:22,current_temperature:21.2,hvac_action:`heating`}),e(`climate.veg_ac_right_veg_ac_right`,`cool`,{temperature:24,current_temperature:24.3,hvac_action:`idle`}),e(`climate.f2_ac_door_f2_ac_door`,`cool`,{temperature:25,current_temperature:25.2,hvac_action:`cooling`}),e(`climate.f2_ac_wall_f2_ac_wall`,`cool`,{temperature:25,current_temperature:24.8,hvac_action:`cooling`}),e(`climate.dryingroom_vault_ac_drying_room_vault_ac`,`cool`,{temperature:18,current_temperature:18.3,hvac_action:`cooling`}),e(`climate.hallway_ac_hallway`,`off`,{temperature:21,current_temperature:21.4}),e(`climate.office_ac_office_ac`,`heat`,{temperature:21,current_temperature:20.8,hvac_action:`idle`})}async function od(){if(Hu){Object.keys(Ku).length||ad(),sd();return}let e=Bu();if(!e)return;let t=id();(await Promise.allSettled(t.map(t=>fetch(`/api/states/`+t,{headers:{Authorization:`Bearer `+e},cache:`no-store`}).then(e=>e.ok?e.json():null)))).forEach((e,n)=>{e.status===`fulfilled`&&e.value&&(Ku[t[n]]=e.value)}),sd()}function sd(){for(let e of Qu){for(let t of e.sensors){let n=t[0],r=t[1],i=t[2],a=t[3],o=t[4],s=e._el.querySelector(`[data-s="`+n+`"]`);if(!s)continue;let c=qu(r);s.textContent=n===`Dry day`&&c!=null?`Day `+Yu(c,0):c==null?`—`:Yu(c,a)+(i||``),s.className=td(c,o)}e._el.querySelectorAll(`.lt`).forEach(e=>e.classList.toggle(`on`,Ju(e.dataset.ent)===`on`));for(let t of e._acEls){let e=t[0],n=t[1],r=Ku[e];if(!r)continue;let i=r.attributes||{};n.querySelector(`[data-cur]`).textContent=i.current_temperature==null?`—`:i.current_temperature+`°`,n.querySelector(`[data-set]`).textContent=i.temperature==null?`—`:i.temperature+`°`;let a=r.state||`off`,o=i.hvac_action||a,s=n.querySelector(`[data-mode]`);s.textContent=o,s.className=`acmode-`+(/cool/.test(o)?`cool`:/heat/.test(o)?`heat`:/dry/.test(o)?`dry`:/fan/.test(o)?`fan`:`off`)}let t=(e.roomLights||[]).some(e=>Ju(e)===`on`);$u.has(e.key)||e.key===`Vault`?(e._dark.material.opacity=t?0:.42,e._glow.intensity=t?26:0):e._glow.intensity=t?10:0}for(let e of rd){let t=Ju(e.id)===`on`;e.mesh.visible=t,e.light.intensity=t?14:0}}od(),Hu||setInterval(od,1e4),Jl.setAnimationLoop(e=>{Lu.rotation.y=Math.sin(e*5e-4)*1.1;for(let e of rd)e.mesh.visible&&(e.tex.offset.x-=.012);$l.update(),Jl.render(Yl,Xl),Gu.render(Yl,Xl)});